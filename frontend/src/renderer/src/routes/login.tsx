...
function LoginPage() {
  ...
  return (
    <div className={`min-h-screen w-full bg-card relative overflow-x-hidden`}>
      ...
      >
        ...
        <div className="w-full md:w-[50%] h-full relative z-20 flex flex-col items-center md:items-start justify-center px-12 md:px-24 py-12 text-primary-foreground bg-primary md:bg-transparent">
           <div className={`text-6xl max-md:hidden text-primary-foreground md:text-black drop-shadow-sm pb-4 w-full max-w-sm text-center md:text-left font-pirata`}>
              Anirom
            </div>
            <div className="md:hidden ">
            <img src={logoImg} alt="Anirom Logo" className="h-40 w-auto object-contain drop-shadow-md" />
            </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 w-full max-w-sm">
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                />
                <Link to="/" className="text-[10px] font-bold text-primary-foreground uppercase tracking-[0.1em] hover:text-white transition-colors">
                  Forgot Password?
                </Link>
              </div>
              ...
              <div className="flex justify-center w-[85%] mx-auto text-[11px] uppercase tracking-[0.1em] text-primary-foreground/80">
                ...
                <Link to="/register" className="ml-2 font-bold text-primary-foreground hover:text-white transition-colors">
                  Cadastre-se
                </Link>
              </div>
